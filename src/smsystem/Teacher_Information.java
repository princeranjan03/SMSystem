...
String SQL="SELECT * FROM TEACHER";
    ...
    private void initComponents() {
        ...
        txt_position.setToolTipText("LIKE:Principal etc");
        ...
        txt_id.setToolTipText("Enter Five Digit Teacher's ID");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String sql="Update teacher set teacher_id='"+(r)+"',firstname='"+(fn)+"',lastname='"+(ln)+"',position='"+(position)+"', experience='"+(exp)+"',birthday='"+(date)+"',mobileno='"+(number)+"',sex='"+(sex)+"',permanentaddress='"+(padd)+"',presentaddress='"+(pradd)+"' where teacher_id='"+(r)+"'";
    ...
    private void cmd_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_saveActionPerformed
        ...
        try{
            ...
            String padd=txt_permanent.getText();
            String pradd=txt_present.getText();
            String strSQL="insert into teacher(teacher_id,firstname,lastname,position,experience,birthday,mobileno,sex,permanentaddress,presentaddress) values('"+(r)+"','"+(fn)+"','"+(ln)+"','"+(position)+"','"+(exp)+"','"+(date)+"','"+(number)+"','"+(sex)+"','"+(padd)+"','"+(pradd)+"')";
    ...
    private void cmd_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_deleteActionPerformed
        ...
        try{
            ...
            s = con.createStatement();
            String r=txt_id.getText();
            String sql="delete from teacher where teacher_id='"+(r)+"'";
            int rowsEffected=s.executeUpdate(sql);
            if(rowsEffected==0)
            JOptionPane.showMessageDialog(null,"Record doesn't exist");
            else
